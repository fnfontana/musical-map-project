...
from src.add_wikipedia_links import search_wikipedia_link, add_wikipedia_links
import sqlite3
...
def test_add_wikipedia_links(monkeypatch):
    monkeypatch.setattr('src.add_wikipedia_links.search_wikipedia_link', lambda genre: 'https://en.wikipedia.org/wiki/Test_Genre')
    add_wikipedia_links()
